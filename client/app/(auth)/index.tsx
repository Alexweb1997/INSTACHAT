import { TouchableOpacity, View, Text, KeyboardAvoidingView, Platform, ScrollView, ActivityIndicator } from 'react-native'
    ...
    if (verifying) {
        return (
            <SafeAreaView style={styles.safe}>
                <KeyboardAvoidingView style={styles.kav} behavior={Platform.OS ===
                    ...
                    <ScrollView contentContainerStyle={styles.scroll}
                        ...
                        <View style={styles.logoRow}>
                            <LinearGradient colors={[Colors.primary, Colors.
                                primaryContainer]} style={styles.logoBox}>
                        ...
                        <Text style={styles.subheading}> We sent a verification code to {email}. Please enter it below</Text>
                        ...
                        <View style={styles.form}>
                            ...
                            <View style={styles.field}>
                                ...
                                <TextInput
                                    ...
                                    onChangeText={setVericationCode}
                                ...
                                <LinearGradient colors={[Colors.primary, Colors.primaryContainer]}
                                    ...
                                    {loading ? (
                                        ...
                                        <>
                                            ...
                                            <Ionicons name="arrow-forward" size={18} color=
                                                {Colors.onPrimary} />
                                        </>
                                    )}
                                </LinearGradient>
        ...
        <SafeAreaView style={styles.safe}>
            <KeyboardAvoidingView style={styles.kav} behavior={Platform.OS ===
                ...
                <ScrollView contentContainerStyle={styles.scroll}
                    ...
                    {/* Hero text */}
                    <Text style={styles.heading}>{mode === "login" ? "Welcome back 👋 " : "Create account"
                    }</Text>
                    <Text style={styles.subheading}>{mode === "login" ? "Sign in to continue chatting " : "Fill in your details to create an account"
                    }</Text>
